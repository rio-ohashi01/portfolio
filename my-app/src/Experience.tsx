...
export default class Experience extends React.Component<{ style: any }>{
  ...
  render()
  {
    ...
    var values =
      [
        ["Apr 2019 - PRESENT", "Freelance", "Web Developer", valuesDetails[0]],
        ["Feb 2016 - Jan 2019", "Yayoi Co., Ltd.", "Full-stack Engineer", valuesDetails[1]],
        ["Jul 2014 - Jan 2016", "V-cube Inc", "Web Developer", valuesDetails[2]],
        ["Apr 2012 - Jun 2014", "Alt Inc", "Windows App Programmer", valuesDetails[3]]
      ];
    var experiences = [];
